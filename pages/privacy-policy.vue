...
<template>
  <div class="privacy-policy">
    ...
    <ul>
      ...
      <li>
        <p>
          <strong>Application</strong> refers to MQ3T, the software program
...
<style scoped>
.privacy-policy {
  @apply tw-pt-24 tw-max-w-[900px] tw-mx-auto tw-flex tw-flex-col tw-gap-8;
}
</style>
